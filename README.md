...
MCP Agent Mail includes full Slack integration, enabling agents to send notifications and post messages to Slack channels. See [SLACK.md](SLACK.md) for complete documentation.
...
See [SLACK.md](SLACK.md) for full configuration options, MCP tools reference, webhook setup, and troubleshooting.
